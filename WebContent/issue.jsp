...
<div id="section">
<center>
<h2><u>ISSUE A BOOK</u></h2>
<table border=0>

    <form name="issue_a_book" action="issueBookDetails" method="post">

<tr><th>User Id:</th><td><input type="text" name="uid" id="uid" ></td></tr>
<tr><th>Book Id:</th><td><input type="text" name="bookId" id="bookId" ></td></tr>
<tr><th>Issue Date:</th><td><input type="text" name="issueDate" id="issueDate" ></td></tr>
<tr><th>Return Date:</th><td><input type="text" name="returnDate" id="returnDate" ></td></tr>
<tr><th>Book Name:</th><td><input type="text" name="bookName" id="bookName" ></td></tr>

<tr><br><center><td><input type="submit" name="issue" value="issue"> </center>
</form>
</table>
